...
begin
    ...
    set src_idx = (select stoppage_idx from path as T where T.train_no = train_no and T.station_code = src_idx);
    set dest_idx = (select stoppage_idx from path as T where T.train_no = train_no and T.station_code = dest_idx);
